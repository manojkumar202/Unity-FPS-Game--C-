...
public class enemy3gun : MonoBehaviour {
    ...
    void Update() {
        ...
        if(GetComponent<Enemy3Movement>().player.GetComponent<Gun>().health>0)
        {
    ...
    {
        if((GetComponent<Enemy3Movement>().startplayerShoot == 0))
        {
            firststartshoot = 0;
        }
        else if((GetComponent<Enemy3Movement>().startplayerShoot == 1) && firststartshoot==0)
        {
