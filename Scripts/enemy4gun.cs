...
public class enemy4gun : MonoBehaviour {
    ...
    void Update() {
        ...
        if(GetComponent<Enemy4Movement>().player.GetComponent<Gun>().health>0)
        {
    ...
    {
        if((GetComponent<Enemy4Movement>().startplayerShoot == 0))
        {
            firststartshoot = 0;
        }
        else if((GetComponent<Enemy4Movement>().startplayerShoot == 1) && firststartshoot==0)
        {
